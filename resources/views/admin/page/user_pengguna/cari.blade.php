...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-user-tie"></i> Data User Pengguna</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"> Data User Pengguna</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!-- Main content -->
    <section class="content">
            <div class="card">
             ...
             <i class="fas fa-list-ul"></i> Daftar  User Pengguna</h3>
                <div class="card-tools">
                  <a href="{{url('/user_pengguna.tambah')}}" 
                  class="btn btn-sm btn-info float-right">
                  <i class="fas fa-plus"></i> Tambah  User Pengguna</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="col-md-12">
                ...
                @if($JumlahDataUserPengguna>0)
                
                <div class="col-sm-12">                  
                      <div class="alert alert-success" 
                       role="alert">Ditemukan {{ $JumlahDataUserPengguna }} 
              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                       ...
                       <a href="{{url('/user_pengguna.'.$UserPengguna->id_user_pengguna.'.edit')}}" class="btn btn-xs btn-info" 
                    ...
                    @endforeach
                    @else
                    <tr><td colspan="5">Belum Ada Data User Pengguna
                    </td></tr>
                    @endif
                    </tbody>
                  </table> 
                  ...
                  <div class="col-sm-12">                  
                      <div class="alert alert-danger" 
                       role="alert">Data dengan kata kunci : 
                        {{ $cari }}
                        Tidak ditemukan,  
                        <a href="{{url('/user_pengguna')}}"><input 
