...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-edit"></i> Edit Data Genre</h3>
          </div>
          <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <i class="far fa-list-alt"></i> Form Edit Data Genre</h3>
      ...
      action="{{ url('/genre.'.$DataGenre->id_genre) }}"
      ...
      <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              is-invalid @enderror" name="genre" 
              id="genre" value="{{ $DataGenre->genre}}">
            </div>
          </div>
