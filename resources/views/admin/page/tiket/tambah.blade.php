...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-plus"></i> Tambah Tiket</h3>
          </div>
          <div class="col-sm-6">
...
<section class="content">
    <div class="card card-info">
      <div class="card-header">
       ...
       <i class="far fa-list-alt"></i> Form Tambah Data Tiket</h3>
      ...
      <div class="card-body">
        <div class="form-group row">
          <label for="foto" class="col-sm-12 col-form-label">
            <span class="text-info">
              <i class="fas fa-user-circle"></i> <u>Data Tiket</u>
            </span></label>
          </div>         
        ...
        Kursi</label>
        <div class="col-sm-7">
          <select class="form-control @error('kursi') 
      is-invalid @enderror" id="kursi" name="kursi">
            <option value="">- Pilih Kursi -</option>
            @if (!empty($DataKursi))
                @foreach($DataKursi as $key => $Kursi)
                    <option value="{{ $Kursi->id_kursi }}">{{ $Kursi->nomor_kursi }}</option>
                @endforeach
            @endif
          </select>
        </div>
