            ...
            <div class="card">
             ...
             <i class="fas fa-list-ul"></i> Daftar  Tiket</h3>
              ...
              <div class="col-md-12">
                ...
                @if($JumlahDataTiket>0)
                
                <div class="col-sm-12">                  
                      <div class="alert alert-success" 
                       role="alert">Ditemukan {{ $JumlahDataTiket }} 
              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                       ...
                       <a href="{{url('/tiket.'.$Tiket->id_tiket.'.edit')}}" class="btn btn-xs btn-info" 
                    ...
                    @endforeach
                    @else
                    <tr><td colspan="5">Belum ada data Nomor tiket
                    </td></tr>
                    @endif
                    </tbody>
                  </table> 
