...
<section class="content">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <i class="far fa-list-alt"></i> Form Edit Data Kategori</h3>
      ...
      action="{{ url('/kategori.'.$DataKategori->id_kategori) }}"
      ...
      <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              is-invalid @enderror" name="kategori" 
              id="kategori" value="{{ $DataKategori->kategori}}">
            </div>
          </div>
