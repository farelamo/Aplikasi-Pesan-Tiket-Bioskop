...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-edit"></i> Edit Data Notifikasi</h3>
          </div>
          <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <i class="far fa-list-alt"></i> Form Edit Data Notifikasi</h3>
      ...
      action="{{ url('/notifikasi.'.$DataNotifikasi->id_notifikasi) }}"
      ...
      <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              id="status" value="{{ $DataNotifikasi->status}}">
            </div>
          </div>
