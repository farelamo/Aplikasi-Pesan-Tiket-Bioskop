            ...
            <div class="card">
             ...
             <i class="fas fa-list-ul"></i> Daftar  Notifikasi</h3>
              ...
              <div class="col-md-12">
                ...
                @if($JumlahDataNotifikasi>0)
                
                <div class="col-sm-12">                  
                      <div class="alert alert-success" 
                       role="alert">Ditemukan {{ $JumlahDataNotifikasi }} 
              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                       ...
                       <a href="{{url('/notifikasi.'.$Notifikasi->id_notifikasi.'.edit')}}" class="btn btn-xs btn-info" 
