...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="{{url('user/css/bootstrap-reboot.min.css') }}">
	<link rel="stylesheet" href="{{url('user/css/bootstrap-grid.min.css') }}">
	<link rel="stylesheet" href="{{url('user/css/owl.carousel.min.css') }}">
	<link rel="stylesheet" href="{{url('user/css/jquery.mCustomScrollbar.min.css') }}">
	<link rel="stylesheet" href="{{url('user/css/nouislider.min.css') }}">
	<link rel="stylesheet" href="{{url('user/css/ionicons.min.css') }}">
	<link rel="stylesheet" href="{{url('user/css/plyr.css') }}">
	<link rel="stylesheet" href="{{url('user/css/photoswipe.css') }}">
	<link rel="stylesheet" href="{{url('user/css/default-skin.css') }}">
				...
				<div class="row">
					<div class="col-12">
						<div class="header__content">
							<!-- header logo -->
							<a href="{{('url master.blade.php" class="header__logo') }}">
							...
							<div class="header__auth">
								...
								<a href="/signup" class="header__sign-in">
									<i class="icon ion-ios-log-in"></i>
									<span>sign up</span>
								</a>

								<a href="{{ url('/user/logout') }}" class="header__sign-in">
							...
							<div class="card card--big">
								...
								@foreach ($data2 as $item)
									<div class="card__content">
										<h3 class="card__title"><a href="#">{{ $item->judul }}</a></h3>
...
@endforeach
	...
	<section class="section">
		<div class="container">
			<div class="row">
				...
				<div class="col-6 col-sm-4 col-md-3 col-lg-2">
					<a href="#" class="partner">
						<img src="{{url('user/img/partners/3docean-light-background.png') }}" alt="" class="partner__img">
					</a>
				</div>
				<!-- end partner -->
			</div>
	...
	<script src="{{url('user/js/jquery.mousewheel.min.js') }}"></script>
	<script src="{{url('user/js/jquery.mCustomScrollbar.min.js') }}"></script>
	<script src="{{url('user/js/wNumb.js') }}"></script>
	<script src="{{url('user/js/nouislider.min.js') }}"></script>
	<script src="{{url('user/js/plyr.min.js') }}"></script>
	<script src="{{url('user/js/jquery.morelines.min.js') }}"></script>
	<script src="{{url('user/js/photoswipe.min.js') }}"></script>
	<script src="{{url('user/js/photoswipe-ui-default.min.js') }}"></script>
