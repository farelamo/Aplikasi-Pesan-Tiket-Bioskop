...
<body class="body">
	...
	<div class="sign section--bg" data-bg="{{ asset('user/img/section/section.jpg')}}">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						<!-- authorization form -->
						<form action="/user/login" class="sign__form" method="post">
							@csrf
							<a href="index.html" class="sign__logo">
								<img src="{{ asset('user/img/logo.svg')}}" alt="">
							</a>
